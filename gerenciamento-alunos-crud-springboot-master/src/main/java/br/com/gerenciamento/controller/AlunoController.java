...
public class AlunoController {
    ...
    public ModelAndView listaAlunosPorCurso(@RequestParam(required = false) Curso curso) {
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("Aluno/alunos-por-curso");
        if (curso != null) {
            modelAndView.addObject("alunosList", alunoRepository.findByCursoOrderByNomeAsc(curso));
        } else {
            modelAndView.addObject("alunosList", alunoRepository.findAll());
        }
