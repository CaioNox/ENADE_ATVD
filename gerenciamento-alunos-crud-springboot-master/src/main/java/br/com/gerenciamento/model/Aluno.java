...
public class Aluno {
    ...
    @NotNull
    @javax.validation.constraints.NotNull(message = "A nota do ENADE é obrigatória")
    @DecimalMin(value = "0.0", message = "A nota do ENADE deve estar entre 0 e 100")
    @DecimalMax(value = "100.0", message = "A nota do ENADE deve estar entre 0 e 100")
